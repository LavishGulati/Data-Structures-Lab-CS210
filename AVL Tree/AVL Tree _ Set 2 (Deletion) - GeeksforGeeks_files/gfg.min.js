...
window.alert("Article is under review. Check back later");else window.open(contributeUrl+'wp-admin/post.php?post='+result+'&action=edit','_blank')},async:!1})}
...
mtq_score_percent[mtqid]=0;if(mtq_max_score[mtqid]>0){mtq_score_percent[mtqid]=mtq_current_score[mtqid]/mtq_max_score[mtqid]*100}}
jQuery(document).ready(mtq_init);function redirectToIDE(divCode,lang){var contentDivId=jQuery(divCode).parent().parent().attr('id');var contentDiv=document.getElementById(contentDivId);var codeDivs=contentDiv.getElementsByClassName('line');var code='';for(var i=0;i<codeDivs.length;i++){code=code+codeDivs[i].textContent+"\r\n"}
